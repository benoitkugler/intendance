...
// struct2ts:github.com/benoitkugler/intendance/server/views.OptionsAssistantCreateRepass
...
// struct2ts:github.com/benoitkugler/intendance/server/views.InAssistantCreateRepass
export interface InAssistantCreateRepass {
	Options: OptionsAssistantCreateRepass;
	GroupesSorties: { [key: number]: []int64 };
}

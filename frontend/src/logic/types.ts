...
export interface OutIngredients {
	token: string;
	ingredients: { [key: number]: Ingredient | undefined };
}
...
export interface OutRecettes {
	token: string;
	recettes: { [key: number]: Recette | undefined };
}
...
export interface OutMenus {
	token: string;
	menus: { [key: number]: Menu | undefined };
}
